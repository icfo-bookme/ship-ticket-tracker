    ...
    <div class="max-w-7xl mx-auto pt-12 lg:p-6">
        ...
        <div class="   rounded-xl overflow-hidden">
            <form id="ticketForm" action="{{ route('publicForm.store') }}" method="POST" class="">
                ...
                <div
                    class=" mb-3 bg-blue-50 p-8 rounded-xl border border-green-200 ">
                    <div class="border-b border-gray-200  pb-4">
                        <div class="flex items-center gap-2">
                            <i class="fa-solid fa-user text-blue-950"></i>
                            <h2 class="text-xl font-semibold text-gray-800 ">Passenger Information</h2>
                        </div>

                        <p class="text-gray-600  text-sm mt-1">Basic details of the primary passenger
                        </p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="customer_name" value="{{ old('customer_name') }}"
                                ...
                                class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition shadow-sm"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            focus:ring-2 focus:ring-blue-500">
                                    <span class="text-sm text-gray-700 ">Same as Mobile</span>
                                </label>
                            </div>
                        </div>
                ...
                <!-- Ship & Journey Info -->
                <div
                    class="mb-3 bg-blue-50 p-8 rounded-xl border border-blue-200 ">
                    <div class="border-b border-gray-200  pb-4">
                        <div class="flex items-center gap-2">
                            <i class="fa-solid fa-route text-blue-950"></i>
                            <h2 class="text-xl font-semibold text-gray-800 ">Journey Details</h2>
                        </div>

                        <p class="text-gray-600  text-sm mt-1">Information about the ship and journey
                            dates</p>
                    </div>
                ...
                <!-- Ticket Categories -->
                <div
                    class="mb-3 bg-blue-50 p-8 rounded-xl border border-yellow-200 ">
                    <div class="border-b border-gray-200  pb-4">
                        <div class="flex items-center gap-2">
                        ...
                        <p class="text-gray-600  text-sm mt-1">Select ticket types for departure and
                            return journeys</p>
                    </div>

                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <div
                            class="border-2 border-blue-200  rounded-xl p-6 bg-blue-50  shadow-sm">
                        ...
                        <div class="border-2 border-green-200  rounded-xl p-6 bg-green-50  shadow-sm"
                            ...
                            <div id="noReturnCategoriesMessage" class="text-gray-500  text-sm mt-2">
                ...
                <!-- Payment Details -->
                <div
                    class="mb-3  bg-blue-50 p-8 rounded-xl border border-gray-200 ">
                    <div class="border-b border-gray-200  pb-4">
                        <div class="flex items-center gap-2">
                        ...
                        <p class="text-gray-600  text-sm mt-1">Add payment methods and amounts</p>
                    </div>
                ...
                <!-- Ticket Summary -->
                <div
                    class="space-y-6 mb-3 bg-blue-50 p-8 rounded-xl border border-slate-200 ">
                    <div class="border-b border-gray-200  pb-4">

                        <div class="flex items-center gap-2">
                            <i class="fa-solid fa-ticket text-blue-950"></i>
                            <h2 class="text-xl font-semibold text-gray-800 ">Ticket Summary</h2>
                        </div>

                        <p class="text-gray-600 text-sm mt-1">Overview of ticket quantities and
                            pricing</p>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <input type="number" id="total_tickets" name="number_of_ticket" value="0"
                                    min="0" readonly
                                    class="w-full border border-gray-300  bg-gray-100   rounded-lg px-4 py-3 shadow-sm">
                            </div>
                ...
                <!-- Payment Summary -->
                <div
                    class="space-y-6 mb-3 bg-blue-50 p-8 rounded-xl border border-blue-200  ">
                    <div class="border-b border-gray-200  pb-4">
                        <div class="flex items-center gap-2">
                            <i class="fa-solid fa-credit-card text-blue-950"></i>
                        ...
                        <p class="text-gray-600  text-sm mt-1">Financial overview of the transaction
                        </p>
                    </div>
                ...
                <!-- Address & Remarks -->
                <div
                    class="space-y-6 mb-3 bg-blue-50 p-8 rounded-xl border ">
                    <div class="border-b border-gray-200  pb-4">
                        <div class="flex items-center gap-2">
                        ...
                        <p class="text-gray-600  text-sm mt-1">Address and remarks for the booking
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea id="address" name="address" placeholder="Enter your address here" rows="3"
                            class="w-full border border-gray-300  rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition shadow-sm">{{ old('address') }}</textarea>
                    </div>
                ...
                <div
                    ...
                    <div class="border-b border-gray-200  pb-4">
                        <div class="flex items-center gap-2">
                            ...
                            <h2 class="text-xl font-semibold text-gray-800 ">Co-Passenger Details</h2>
                        </div>

                        <p class="text-gray-600  text-sm mt-1">Add information for additional
                            passengers</p>
                    </div>
                ...
                <div class="flex items-center justify-end gap-4 pt-8 border-t border-gray-200 ">
                    <a href="{{ route('ship-ticket-sales.create') }}"
                        class="px-6 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 focus:ring-4 focus:ring-gray-200  transition shadow-sm">
                        Cancel
                    </a>
                    <button type="button" id="reviewButton"
                        class="px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:ring-4 focus:ring-blue-300  transition shadow-sm flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
