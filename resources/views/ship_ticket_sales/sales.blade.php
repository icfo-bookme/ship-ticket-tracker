             ...
             <div class="mt-3 h-full">
                 ...
                 <form id="editForm" class="mt-4">
                     ...
                     <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                         ...
                         <div class="mb-4">
                             <label for="editMobile" class="block text-sm font-medium text-gray-700">Customer
                                 Mobile</label>
                         ...
                         <!-- Ticket Fee -->
                         <div class="mb-4">
                             <label for="editTicketFee" class="block text-sm font-medium text-gray-700">Ticket
                                 Fee</label>
                         ...
                         <div class="mb-4">
                             <label for="editDueAmount" class="block text-sm font-medium text-gray-700">Due
                                 Amount</label>
