    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                ...
                <button data-modal-hide="update-modal" type="button" class="text-gray-500 dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-600 rounded-lg p-2.5">
            ...
            <form id="updateShipForm">
                ...
                <div class="px-6 py-4">
                    <div class="mb-4">
                        <label for="update-name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">spreadsheetId</label>
                        <input type="text" id="update-name" name="spreadsheetId" required
                    ...
                    <div class="mb-4">
                        <label for="update-route" class="block text-sm font-medium text-gray-700 dark:text-gray-300">range</label>
                        <input type="text" id="update-route" name="range" required
                               class="block w-full p-2 text-sm text-gray-900 bg-gray-50 rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                               >
                    </div>
...
<script>
    ...
    function showEditModal(btn) {
        ...
        document.getElementById('update-name').value = btn.dataset.spreadsheetId;
        document.getElementById('update-route').value = btn.dataset.range;
