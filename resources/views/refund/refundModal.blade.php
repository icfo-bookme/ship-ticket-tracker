<x-entity-modal id="refundModal" title="Refund" maxWidth="lg" :hideFooter="true">
    <div class="p-6">
        ...
        <div class="flex justify-end mt-6">
            <button id="submitRefundBtn" type="button" class="bg-blue-500 text-white px-4 py-2 rounded">Refund</button>
