    ...
    <div class="py-6">
        ...
        <div id="statusFilter" data-status="{{ $status }}" class="hidden"></div>
            ...
            <div class="mt-6 mb-4 grid grid-cols-3 gap-10">
                ...
                <div class="">
                    <label for="companyFilter" class="block text-sm font-medium text-gray-700">Filter by Source Company</label>
                ...
                <form id="editForm" class="mt-4">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="editCustomerName" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select id="editShip" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        ...
                        <div class="mb-4">
                            <label for="editReceivedAmount" class="block text-sm font-medium text-gray-700">Received Amount</label>
                            <input type="number" step="0.01" id="editReceivedAmount" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        </div>
                        
                        <div class="mb-4">
                            <label for="editDueAmount" class="block text-sm font-medium text-gray-700">Due Amount</label>
                            <input type="number" step="0.01" id="editDueAmount" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        </div>
                        
                        <!-- Company -->
                        <div class="mb-4">
                            <label for="editCompany" class="block text-sm font-medium text-gray-700">Company</label>
                            <select id="editCompany" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        ...
                        <!-- Issued Date -->
                        <div class="mb-4">
                            <label for="editIssuedDate" class="block text-sm font-medium text-gray-700">Issued Date</label>
                            <input type="date" id="editIssuedDate" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        </div>
                    
                        <!-- Sold By -->
                        <div class="mb-4">
                            <label for="editSoldBy" class="block text-sm font-medium text-gray-700">Sold By</label>
                            <input type="text" id="editSoldBy" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                        </div>
