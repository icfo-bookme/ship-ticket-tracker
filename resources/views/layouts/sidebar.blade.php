<div id="sidebar" class="">
    ...
    <div class="flex flex-col h-full transition-all duration-300 ease-in-out" id="sidebar-container">
        ...
        <div id="divHide" class="flex items-center w-60 justify-between h-16 px-4 bg-blue-900 shadow-md">
            <span id="sidebar-logo-text" class="text-white text-xl font-semibold whitespace-nowrap transition-all duration-300 sidebar-text truncate">Ship Booking</span>
                    ...
                    <div id="sell-dropdown" class="mb-1 relative">
                        <button class="flex items-center justify-between w-full px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 group transition focus:outline-none">
                            <div class="flex items-center">
                                ...
                                <span class="ml-3 whitespace-nowrap transition-all duration-300 sidebar-text truncate text-left">Sell</span>
                            </div>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200 text-gray-500" id="sell-dropdown-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="create-dropdown" class="mb-1 relative">
                        <button class="flex items-center justify-between w-full px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 group transition focus:outline-none">
                            <div class="flex items-center">
                                ...
                                <span class="ml-3 whitespace-nowrap transition-all duration-300 sidebar-text truncate text-left">Create</span>
                            </div>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200 text-gray-500" id="create-dropdown-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                    ...
                    <div id="reports-dropdown" class="mb-1 relative">
                        <button class="flex items-center justify-between w-full px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 group transition focus:outline-none">
                            <div class="flex items-center">
                                ...
                                <span class="ml-3 whitespace-nowrap transition-all duration-300 sidebar-text truncate text-left">Show Reports</span>
                            </div>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200 text-gray-500" id="reports-dropdown-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="reports-dropdown-list" class="mt-1 space-y-1 pl-8 hidden">
                            <a href="/admin/sales-reports" class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-blue-50 group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-500 mr-3"></span>
                                <span class="whitespace-nowrap transition-all duration-300 sidebar-text truncate">Sales Reports</span>
                            </a>
                            <a href="/admin/booking-reports" class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-blue-50 group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-500 mr-3"></span>
                                <span class="whitespace-nowrap transition-all duration-300 sidebar-text truncate">Booking Reports</span>
                            </a>
                        </div>
                    </div>
                </div>
