    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center">
                <!-- Mobile menu toggle (hamburger) - only visible below lg -->
                <button id="mobileSidebarToggle" type="button"
                    class="lg:hidden p-2 mr-2 text-white rounded-md hover:bg-[#004d5a] focus:outline-none focus:ring-2 focus:ring-blue-300"
