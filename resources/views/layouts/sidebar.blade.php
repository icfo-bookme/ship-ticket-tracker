            ...
            <nav class="flex-1 space-y-1">
              ...
              {{ request()->is('refunds/create') ? 'bg-blue-100 text-blue-600' : '' }}">
                ...
                <div class="px-2 pt-2">
                 ...
                 <div class="px-2 pt-2">
                    <div id="user-dropdown" class="mb-1 relative">
                        <button
                            class="flex items-center justify-between w-full px-3 py-2.5 text-sm font-medium text-gray-700 rounded-lg hover:bg-blue-50 group transition focus:outline-none">
                            <div class="flex items-center">
                                <i class="fas fa-user text-blue-600"></i>
                                <span
                                    class="ml-3 whitespace-nowrap transition-all duration-300 sidebar-text truncate text-left">User Management</span>
                            </div>
                            <svg class="w-4 h-4 flex-shrink-0 transition-transform duration-200 text-gray-500"
                                id="user-dropdown-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div id="user-dropdown-list" class="mt-1 space-y-1 pl-8 hidden">
                            <a href="/admin/whatsapp"
                                class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-blue-50 group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-500 mr-3"></span>
                                <span
                                    class="whitespace-nowrap transition-all duration-300 sidebar-text truncate">Roles Managements</span>
                            </a>
                            <a href="/admin/whatsapp"
                                class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-blue-50 group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-500 mr-3"></span>
                                <span
                                    class="whitespace-nowrap transition-all duration-300 sidebar-text truncate">User Logs</span>
                            </a>
                             <a href="/admin/whatsapp"
                                class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 rounded-lg hover:bg-blue-50 group transition">
                                <span class="w-1.5 h-1.5 rounded-full bg-blue-500 mr-3"></span>
                                <span
                                    class="whitespace-nowrap transition-all duration-300 sidebar-text truncate">Activity Tracking</span>
                            </a>
